const mainText = {
    ...
    jop1Detail: 
        ...
        `,
    jopTitle2: "Software projects",
    jopTitle2Detail: "I created several websites for myself and for clients remotely <br>2023",
    jop2Detail: 
        `
            <li class="font12">- A website to display prayer times updated daily using HTML , CSS , JS, Axios library, and API </li>
            <li class="font12">- personal website, which contains my CV and website projects </li>
            <li class="font12">- A website for a law firm using HTML, CSS, JS without using  libraries</li>
